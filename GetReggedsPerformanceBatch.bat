...
echo %w%╟───────────────────────────────────────┴───────────────────────────────────────┴──────────────────────────────────────╢%y%
echo %w%║%y%    %w%[%y% %c%%u%1%q% %t%%w%]%y% %c%Windows Energizer%t%                %w%[%y% %c%%u%6%q%%t% %w%]%y% %c%Program Downloader%t%                                                   %w%║%y%
echo %w%║%y%                                                                                                                      %w%║%y%
echo %w%║%y%    %w%[%y% %c%%u%2%q%%t% %w%]%y% %c%Windows Optimizer%t%                %w%[%y% %c%%u%7%q%%t% %w%]%y% %c%Program Updater%t%                                                      %w%║%y%
echo %w%║%y%                                                                                                                      %w%║%y%
...
if '%choice%'=='6' goto ProgramDownloader
if '%choice%'=='7' goto ProgramUpdater
...
:: Start > Settings > Gaming > Game Mode > On (Seems to improve 1% lows)
...
reg add "HKCR\AllFilesystemObjects\shell\PermanentDelete" /v "ExplorerCommandHandler" /t REG_SZ /d "{E9571AB2-AD92-4EC6-8924-4E5AD33790F5}" /f >nul 2>&1
...
reg add "HKU\.DEFAULT\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Accent" /v "AccentPalette" /t REG_BINARY /d "808080aa000000aa808080aa808080aa000000aa000000aa000000aa000000aa" /f >nul 2>&1
