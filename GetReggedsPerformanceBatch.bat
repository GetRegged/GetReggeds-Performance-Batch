...
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Accent" /v "AccentPalette" /t REG_BINARY /d "ffffffffffffffffffffffffffffffff000000ff000000ff000000ff000000ff" /f >nul 2>&1
...
reg add "HKEY_USERS\.DEFAULT\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Accent" /v "AccentPalette" /t REG_BINARY /d "ffffffffffffffffffffffffffffffff000000ff000000ff000000ff000000ff" /f >nul 2>&1
