...
echo %w%╟──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╢%y%
echo %w%║%y%    %w%[%y% %c%%u%1%q%%t% %w%]%y% %c%Black%t%       %w%[%y% %c%%u%1%q%%t% %w%]%y% %c%Blue%t%                                                        %w%║%y%
echo %w%║%y%                                                                                                                      %w%║%y%
echo %w%║%y%    %w%[%y% %c%%u%2%q%%t% %w%]%y% %c%Red%t%         %w%[%y% %c%%u%2%q%%t% %w%]%y% %c%Violet%t%                                                      %w%║%y%
echo %w%║%y%                                                                                                                      %w%║%y%
echo %w%║%y%    %w%[%y% %c%%u%3%q%%t% %w%]%y% %c%Orange%t%      %w%[%y% %c%%u%3%q%%t% %w%]%y% %c%Pink%t%                                                        %w%║%y%
echo %w%║%y%                                                                                                                      %w%║%y%
echo %w%║%y%    %w%[%y% %c%%u%3%q%%t% %w%]%y% %c%Yellow%t%      %w%[%y% %c%%u%3%q%%t% %w%]%y% %c%Rose%t%                                                        %w%║%y%
echo %w%║%y%                                                                                                                      %w%║%y%
echo %w%║%y%    %w%[%y% %c%%u%1%q%%t% %w%]%y% %c%Green%t%                                                                                                       %w%║%y%
echo %w%║%y%                                                                                                                      %w%║%y%
echo %w%║%y%    %w%[%y% %c%%u%1%q%%t% %w%]%y% %c%Cyan%t%                                                                                                        %w%║%y%
echo %w%║%y%                                                     %w%╔══════════╗%y%                                                     %w%║%y%
echo %w%║%y%						      %w%║%y%%w%[%y% %c%%u%0%q%%t% %w%]%y% %c%Menu%t%%w%║%y%                                                     %w%║%y%
echo %w%╚═════════════════════════════════════════════════════╩══════════╩═════════════════════════════════════════════════════╝%y%
set choice=
...
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Accent" /v "AccentPalette" /t REG_BINARY /d "ffffffff000000ffffffffffffffffff000000ff000000ff000000ff000000ff" /f >nul 2>&1
...
reg add "HKEY_USERS\.DEFAULT\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Accent" /v "AccentPalette" /t REG_BINARY /d "ffffffff000000ffffffffffffffffff000000ff000000ff000000ff000000ff" /f >nul 2>&1
